...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ethernet_10gbe/s_axi_resetn_peripherals] [get_bd_pins hdmi_out/s_axi_resetn_peripherals] [get_bd_pins interconnect_ddr_pl/aresetn] [get_bd_pins interconnect_ddr_ps/M00_ARESETN] [get_bd_pins interconnect_ddr_ps/S00_ARESETN] [get_bd_pins interconnect_peripherals/M00_ARESETN] [get_bd_pins interconnect_peripherals/M01_ARESETN] [get_bd_pins interconnect_peripherals/M02_ARESETN] [get_bd_pins interconnect_peripherals/M03_ARESETN] [get_bd_pins interconnect_peripherals/M04_ARESETN] [get_bd_pins interconnect_peripherals/M05_ARESETN] [get_bd_pins interconnect_peripherals/M06_ARESETN] [get_bd_pins interconnect_peripherals/S00_ARESETN] [get_bd_pins reset_peripherals/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins ethernet_10gbe/s_axi_clk_peripherals] [get_bd_pins hdmi_out/s_axi_clk_peripherals] [get_bd_pins interconnect_ddr_ps/ACLK] [get_bd_pins interconnect_ddr_ps/M00_ACLK] [get_bd_pins interconnect_ddr_ps/S00_ACLK] [get_bd_pins interconnect_peripherals/ACLK] [get_bd_pins interconnect_peripherals/M00_ACLK] [get_bd_pins interconnect_peripherals/M01_ACLK] [get_bd_pins interconnect_peripherals/M02_ACLK] [get_bd_pins interconnect_peripherals/M03_ACLK] [get_bd_pins interconnect_peripherals/M04_ACLK] [get_bd_pins interconnect_peripherals/M05_ACLK] [get_bd_pins interconnect_peripherals/M06_ACLK] [get_bd_pins interconnect_peripherals/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins reset_peripherals/slowest_sync_clk]
